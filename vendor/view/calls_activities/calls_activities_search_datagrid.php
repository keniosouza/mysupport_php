...
$CallsActivitiesAllBySectionIdResult = $CallsActivities->Search($_POST['text']); ?>
...
<div class="row g-1 animate slideIn">
    ...
    foreach ($CallsActivitiesAllBySectionIdResult as $key => $result) {
        ...
        <div class="col-md-3 d-flex">
            ...
            <div id="<?php echo $result->context_menu->zone?>" class="card <?php echo ($key + 1) < count($CallsActivitiesAllBySectionIdResult) ? 'mb-1' : null; ?> cursor-pointer w-100">
                ...
                <div class="card-footer border-0 bg-transparent">
                    ...
                    <span class="badge bg-primary">
                        ...
                        Conclusão: <?php echo date('d/m/Y', strtotime($result->date_expected)) ?>
