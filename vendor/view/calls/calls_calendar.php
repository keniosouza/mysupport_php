...
$CallsAllCalendarResult = $Calls->AllCalendar(@(int)$_SESSION['USERSCOMPANYID']);
$CallsActivitiesAllCalendarResult = $CallsActivities->AllCalendar(@(int)$_SESSION['USERSCOMPANYID']);
$CallsActivitiesUsersAllCalendarResult = $CallsActivitiesUsers->AllCalendar(@(int)$_SESSION['USERSCOMPANYID']);
