...
<div class="col-md-12 animate slideIn">
    ...
    <div class="card shadow-sm border">
        ...
        <form class="card-body" role="form" id="CallsActivitiesTypeForm">
            ...
            <div class="row g-1">
                ...
                <div class="col-md-12" id="CallsActivitiesTypeFormMessages"></div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-sm w-100" role="group" aria-label="Basic example">
                            ...
                            <button class="btn btn-primary" onclick="SendRequest('CallsActivitiesTypeForm', {target : 'CallsActivitiesTypeFormMessages', block : {create : true, info : null, sec : null, target : 'CallsActivitiesTypeFormMessages', data : 'Aguarde...', color : 'blue', type : 'circle', size : 'sm', message : true}});">
            ...
            <input type="hidden" name="TABLE" value="CALLS_ACTIVITIES_TYPES" />
            <input type="hidden" name="ACTION" value="CALLS_ACTIVITIES_TYPES_SAVE" />
