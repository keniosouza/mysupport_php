...
<div class="col-md-12 animate slideIn">
    ...
    <div class="card shadow-sm border">
        ...
        <form class="card-body" role="form" id="CallsActivitiesPrioritiesForm">
            ...
            <div class="row g-1">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input id="description" type="text" class="form-control form-control-solid" name="description" value="<?php echo @(string)$resultCallsActivitiesTypes->description ?>">

                    </div>

                </div>

                <div class="col-md-12" id="CallsActivitiesPrioritiesFormMessages"></div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-sm w-100" role="group" aria-label="Basic example">
                            ...
                            <button class="btn btn-primary" onclick="SendRequest('CallsActivitiesPrioritiesForm', {target : 'CallsActivitiesPrioritiesFormMessages', block : {create : true, info : null, sec : null, target : 'CallsActivitiesPrioritiesFormMessages', data : 'Aguarde...', color : 'blue', type : 'circle', size : 'sm', message : true}});">
            ...
            <input type="hidden" name="TABLE" value="CALLS_ACTIVITIES_PRIORITIES" />
            <input type="hidden" name="ACTION" value="CALLS_ACTIVITIES_PRIORITIES_SAVE" />
