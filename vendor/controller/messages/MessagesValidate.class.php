...
namespace vendor\controller\messages;

/** Importação de classes */
use vendor\controller\main\Main;

class MessagesValidate
{
    ...
    public function setMessageId(int $messageId): void
    {
        ...
        $this->messageId = isset($messageId) ? $this->Main->antiInjection($messageId) : 0;
    ...
    public function setReceived(? int $received): void
    {
        ...
        /** Tratamento da informação */
        $this->received = isset($received) ? $this->Main->antiInjection($received) : 0;
    ...
    public function setViewed(? int $viewed): void
    {
        ...
        /** Tratamento da informação */
        $this->viewed = isset($viewed) ? $this->Main->antiInjection($viewed) : 0;
