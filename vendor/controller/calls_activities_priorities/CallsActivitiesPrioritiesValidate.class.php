...
namespace vendor\controller\calls_activities_priorities;

/** Importação de classes */
use \vendor\controller\main\Main;

class CallsActivitiesPrioritiesValidate
{
    ...
    public function setCallActivityPriorityId(int $call_activity_priority_id) : void
    {

        /** Tratamento dos dados de entrada */
        $this->call_activity_priority_id = isset($call_activity_priority_id) ? $this->main->antiInjection($call_activity_priority_id) : 0;
    ...
    public function getCallActivityPriorityId() : int
    {
        ...
        return (int)$this->call_activity_priority_id;
